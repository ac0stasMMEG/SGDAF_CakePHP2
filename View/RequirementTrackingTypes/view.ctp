    ...
    <div class="col-xs-12">
		...
		<div class="box box-primary">
			<div class="box-header">
				<h3 class="box-title"><?php  echo __('Requirement Tracking Type'); ?></h3>
				<div class="box-tools pull-right">
	                <?php echo $this->Html->link(__('<i class="glyphicon glyphicon-pencil"></i> Edit'), array('action' => 'edit', $requirementTrackingType['RequirementTrackingType']['id']), array('class' => 'btn btn-primary', 'escape' => false)); ?>
	            </div>
			</div>
		...
		<td>
			<?php echo h($requirementTrackingType['RequirementTrackingType']['id']); ?>
			&nbsp;
		</td>
</tr><tr>		<td><strong><?php echo __('Name'); ?></strong></td>
		<td>
			<?php echo h($requirementTrackingType['RequirementTrackingType']['name']); ?>
			&nbsp;
		</td>
</tr><tr>		<td><strong><?php echo __('Created'); ?></strong></td>
		<td>
			<?php echo h($requirementTrackingType['RequirementTrackingType']['created']); ?>
			&nbsp;
		</td>
</tr><tr>		<td><strong><?php echo __('Modified'); ?></strong></td>
		<td>
			<?php echo h($requirementTrackingType['RequirementTrackingType']['modified']); ?>
			&nbsp;
		</td>
</tr>					</tbody>
			...
			<div class="box box-primary">
				...
				<?php if (!empty($requirementTrackingType['RequirementTracking'])): ?>
		...
		<th class="text-center"><?php echo __('Modified'); ?></th>
							...
							<tbody>
									<?php
										$i = 0;
										foreach ($requirementTrackingType['RequirementTracking'] as $requirementTracking): ?>
		<tr>
