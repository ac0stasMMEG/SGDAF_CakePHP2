...
<div class="row">
    <div class="col-xs-12">
		...
		<th class="text-center"><?php echo __('Importance'); ?></th>
		...
		<tr>
			...
			<td class="text-center"><?php echo $memo['importance']; ?></td>
