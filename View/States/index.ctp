...
<div class="row">
    ...
    <div class="box box-primary">
		<div class="box-header">
			<h3 class="box-title"><?php echo __('States'); ?></h3>
			<div class="box-tools pull-right">
                <?php echo $this->Html->link(__('<i class="glyphicon glyphicon-plus"></i> New State'), array('action' => 'add'), array('class' => 'btn btn-primary', 'escape' => false)); ?>
            </div>
		</div>	
	...
	<tr>
		<td class="text-center"><?php echo h($state['State']['id']); ?>&nbsp;</td>
		<td class="text-center"><?php echo h($state['State']['name']); ?>&nbsp;</td>
		<td class="text-center"><?php echo h($state['State']['created']); ?>&nbsp;</td>
		<td class="text-center"><?php echo h($state['State']['modified']); ?>&nbsp;</td>
