    ...
    <div class="col-xs-12">
		...
		<div class="box box-primary">
			<div class="box-header">
				<h3 class="box-title"><?php  echo __('Matter'); ?></h3>
				<div class="box-tools pull-right">
	                <?php echo $this->Html->link(__('<i class="glyphicon glyphicon-pencil"></i> Edit'), array('action' => 'edit', $matter['Matter']['id']), array('class' => 'btn btn-primary', 'escape' => false)); ?>
	            </div>
			</div>
		...
		<td>
			<?php echo h($matter['Matter']['created']); ?>
			&nbsp;
		</td>
</tr><tr>		<td><strong><?php echo __('Modified'); ?></strong></td>
		<td>
			<?php echo h($matter['Matter']['modified']); ?>
			&nbsp;
		</td>
</tr>					</tbody>
		...
		<th class="text-center"><?php echo __('Matter Id'); ?></th>
