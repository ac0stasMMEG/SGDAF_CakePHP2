...
<html>
	<head>
		...
		<?php 
            ...
            //echo $this->Html->css('../js/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css');
        ...
        <?php 
            ...
            echo $this->Html->script('BootstrapMenu.min');
            ...
            echo $this->Html->script('../js/plugins/ckeditor/ckeditor.js');
