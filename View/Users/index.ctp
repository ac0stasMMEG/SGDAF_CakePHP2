                ...
                <table id="Users" class="table table-bordered table-striped">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center"><?php echo __('Do you want to receive alerts?'); ?></th>
                            <th class="text-center"><?php echo __('¿Unir memorándum?'); ?></th>
                            <th class="text-center"><?php echo __('Ver todos los adjuntos'); ?></th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center"><?php echo $user['User']['area']; ?>&nbsp;</td>
                            <td class="text-center"><?php echo $active[$user['User']['email']]; ?>&nbsp;</td>
                            <td class="text-center"><?php echo @$active[$user['User']['merge']]; ?>&nbsp;</td>
                            <td class="text-center"><?php echo @$active[$user['User']['attach']]; ?>&nbsp;</td>
