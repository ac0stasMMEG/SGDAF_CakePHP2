<?php echo $this->Html->addCrumb(__('Index memos'), 'index'); ?>
            ...
            <div class="box-header">
                <div class="user-block ">
                    <div class="box-tools pull-right">
                        <div class="btn-group">
                            <!-- <button name="<?php //echo Router::url('/memos/all_files/', true).$memo['Memo']['id'].'/Sistema Digital - Ministerio de la Mujer y la Equidad de Género.pdf'; 
                                                ?>" class="btn btn-linkedin online" data-toggle="modal" data-target="#myModalFrame"><?php echo __('<i class="glyphicon glyphicon-resize-full"></i> &nbsp; Ver/Exportar Todos los Archivos'); ?></button> -->
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li>
                                        <?php echo $this->Html->link(
                                            __('Exportar Memos y Formularios de Conformidad'),
                                            array(
                                                'action' => 'all_files', $memo['Memo']['id'] . '/Sistema Digital - Ministerio de la Mujer y la Equidad de Género', 'ext' => 'pdf'
                                            ),
                                            array(
                                                'name' => Router::url('/memos/all_files/', true) . $memo['Memo']['id'] . '/Sistema Digital - Ministerio de la Mujer y la Equidad de Género.pdf', 'class' => 'online', 'data-toggle' => 'modal', 'data-target' => '#myModalFrame'
                                            )
                                        ); ?>
                                    </li>
                                </ul>
                                <?php echo $this->Html->link(__('<i class="glyphicon glyphicon-time"></i> &nbsp; Time Line'), array('action' => 'time_line', $memo['Memo']['id']), array('class' => 'btn btn-linkedin', 'escape' => false, 'data-toggle' => 'tooltip', 'title' => 'time_line')); ?>
                            <?php endif; ?>
                            <?php
                            if (is_null($memo['Memo']['memo_number'])) {
                                ...
                                echo $this->Html->link('<i class="glyphicon glyphicon-send"></i>&nbsp;' . __(' Send'), array('action' => 'send', $memo['Memo']['id']), array('class' => 'btn btn-linkedin', 'escape' => false, 'data-toggle' => 'tooltip', 'title' => 'edit', 'type' => 'button'));
                            ?>
                            ...
                            ?>
                            <?php
                            if (is_null($approved) and ($memo['Memo']['memo_number'])) {
        ...
        <div class="box box-widget widget-user-2">
            <div class="widget-user-header bg-memo-active">
                <div class="widget-user-image">
                    ...
                    <?php else : ?>
                        <?php echo $this->Html->image('../dist/img/boxed-bg.jpg', array('class' => 'img-circle')); ?>
                    <?php endif; ?>
                </div>
                <!-- /.widget-user-image -->
                                            ...
                                            <div class="post">
                                                <div class="user-block">
                                                    <span class="username">
                                                        <?php if ($memos['Memo']['importance']) : ?>
                                                            <a>
                                                                <font color="#dd4b39"><?php echo h('D' . $memos['Memo']['memo_number'] . '-' . $memo['Memo']['year']); ?></font>
                                                            </a>
                                                        <?php else : ?>
                                                ...
                                                <ul class="list-inline">
                                                    <?php if ($memos['Memo']['importance']) : ?>
                                                        ...
                                                        <li class="pull-right">
                                                            <a href="" class="link-black text-sm"><i class="fa fa-calendar margin-r-5"></i><?php echo h($memos['MemoTracking'][0]['created']); ?></a>
                                                        </li>
                                                </ul>
                                            </div>
                                        </td>
...
<div class="modal modal-primary" id="myModalFrame" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <iframe id="popUp" src="" width="100%" height="700px" frameborder="0">
                </iframe>
            </div>
