...
<section class="content">
    <?php if ($this->Session->read('groupDB_id') === '1') : ?>
        <div class="row">
                    ...
                    <div class="box-tools pull-right">
                        <div class="btn-group">
                            <?php echo $this->Html->link(
                                __('<i class="glyphicon glyphicon-refresh"></i> Refresh'),
                                array('action' => 'index'),
                                array('class' => 'btn btn-linkedin', 'escape' => false)
                            ); ?>
                            ...
                            <?php echo ($merge) ? $this->Html->link(__('<i class="glyphicon glyphicon-tags"></i> &nbsp;Unir Memos'), array('action' => 'merge'), array('class' => ' ', 'escape' => false, 'data-toggle' => "modal", 'data-target' => "#myModalMerge")) : NULL; ?>
                                                ...
                                                <tbody>
                                                    <?php foreach ($addresseeMemos as $memo) : ?>
                                                        <tr>
                                                            ...
                                                            <td id="<?php echo $memo['Memo']['id']; ?>" class="selected_td" name="box_1">
                                                                <div class="post">
                                                                    <div class="user-block">
                                                                        <span class="username">
                                                                            <?php if ($memo['Memo']['importance']) : ?>
                                                                                <a>
                                                                                    <font color="#dd4b39"><?php echo h('D' . $memo['Memo']['memo_number'] . '-' . $memo['Memo']['year']); ?></font>
                                                                                </a>
                                                                            <?php else : ?>
                                                                                <a><?php echo h('D' . $memo['Memo']['memo_number'] . '-' . $memo['Memo']['year']); ?></a>
                                                                            <?php endif; ?>
                                                                    ...
                                                                    <ul class="list-inline">
                                                                        <?php if ($memo['Memo']['state_id'] == '60ef08b2-e448-4759-9e42-32b8c26b1ae0') : // Recuperado
                                                                        ?>
                                                                            <li><a href="" class="link-black text-sm"><i class="fa fa-exchange margin-r-5"></i><?php echo __('recuperado'); ?></a>
                                                                            <?php endif; ?>
                                                                        ...
                                                                        <li class="pull-right">
                                                                            <a href="" class="link-black text-sm"><i class="fa fa-calendar margin-r-5"></i><?php echo h($memo['Memo']['memo_date']); ?></a>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                            </td>
                                                ...
                                                <tbody>
                                                    <?php foreach ($myMemos as $memo) : ?>
                                                        <tr>
                                                            ...
                                                            <td id="<?php echo $memo['Memo']['id']; ?>" name="box_2">
                                                                <div class="post">
                                                                    <div class="user-block">
                                            ...
                                            <table class="table table-bordered table-striped mail">
                                                ...
                                                <tbody>
                                                    <?php foreach ($notifyMemos as $memo) : ?>
                                                        <tr>
                                                            <td bgcolor="<?php echo ($memo['MemoTracking']['read']) ? 'transparent' : '#367fa9'; ?>" class="read" id="<?php echo $memo['MemoTracking']['id'] ?>" style="width:10px"></td>
                                                            <td id="<?php echo $memo['Memo']['id']; ?>" name="box_3">
                                                                <div class="post">
                                                                    <div class="user-block">
                                            ...
                                            <table class="table table-bordered table-striped mail">
                                                ...
                                                <tbody>
                                                    <?php foreach ($draftMemos as $memo) : ?>
                                                        <tr>
                                                            <td bgcolor="<?php echo ($memo['MemoTracking']['read']) ? 'transparent' : '#367fa9'; ?>" class="read" id="<?php echo $memo['MemoTracking']['id'] ?>" style="width:10px"></td>
                                                            <td id="<?php echo $memo['Memo']['id']; ?>" name="box_4">
                                                                <div class="post">
                                                                    <div class="user-block">
                                                ...
                                                <tbody>
                                                    <?php foreach ($completeMemos as $memo) : ?>
                                                        <tr>
                                                            ...
                                                            <td id="<?php echo $memo['Memo']['id']; ?>" class="selected_td" name="box_5">
                                                                <div class="post">
                                                                    <div class="user-block">
                                                                        <span class="username">
                                                                            <?php if ($memo['Memo']['importance']) : ?>
...
<div class="modal" id="myModalMerge" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-body modal-merge">
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
...
<script type="text/javascript">
    ...
    $('#myModalMerge').on('hidden.bs.modal', function(e) {
    ...
    if (localStorage.getItem('memo_id') !== null) {
        $("#memoDetail").load("<?php echo $this->Html->url(array('action' => 'view_detail'), true) ?>", {
            memo_detail_id: localStorage.getItem('memo_id'),
            box: null
        });
    } else {
        var addressee_memo_id = "<?php echo !empty($addresseeMemos[0]['Memo']['id']) ? $addresseeMemos[0]['Memo']['id'] : NULL; ?>";
        $("#memoDetail").load("<?php echo $this->Html->url(array('action' => 'view_detail'), true) ?>", {
            memo_detail_id: addressee_memo_id,
            box: null
        });
    }
    ...
    var menu = new BootstrapMenu('.table', {
        actions: [{
            ...
            name: "<?php echo __('El memo ha sido recuperado'); ?>",
