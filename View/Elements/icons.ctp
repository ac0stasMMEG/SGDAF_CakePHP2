  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"><?php echo __("Please click on the desired icon"); ?></h4>
      </div>
                  ...
                  <div class="tab-pane active" id="fa-icons">
                    <section id="new">
                      ...
                      <div class="row fontawesome-icon-list">
                        <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-500px"></i> fa-500px</button></div>
